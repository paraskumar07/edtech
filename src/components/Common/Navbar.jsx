...
//                       ) : Array.isArray(subLinks) && subLinks.filter((subLink) => Array.isArray(subLink?.courses) && subLink.courses.length > 0).length > 0 ? (
//                         <>
//                           {subLinks
              ...
              <li key={index}>
                {link.title === "Catalog" ? (
                  ...
                  >
                    ...
                    {/* Dropdown */}
                    <div className="invisible absolute left-[50%] top-full z-[1000] w-[200px] -translate-x-[50%] translate-y-2 flex-col rounded-lg bg-richblack-5 p-4 text-richblack-900 opacity-0 transition-all duration-150 group-hover:visible group-hover:opacity-100 group-hover:translate-y-3 lg:w-[300px]">
                      <div className="absolute left-[50%] top-0 -z-10 h-6 w-6 translate-x-[80%] -translate-y-2 rotate-45 select-none rounded bg-richblack-5"></div>

                      {loading ? (
                        <p className="text-center">Loading...</p>
                      ) : Array.isArray(subLinks) &&
                        subLinks.some((cat) => Array.isArray(cat.courses) && cat.courses.length > 0) ? (
                        subLinks
                          .filter((cat) => Array.isArray(cat.courses) && cat.courses.length > 0)
                          .map((cat, i) => (
                            <Link
